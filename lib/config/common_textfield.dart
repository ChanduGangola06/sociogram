    ...
    child: Container(
      ...
      child: TextField(
        style: const TextStyle(
            color: Colors.white, fontSize: 12, fontFamily: 'Urbanist-medium'),
        decoration: InputDecoration(
          hintText: text,
          hintStyle: const TextStyle(
              color: Colors.white, fontFamily: 'Urbanist-medium'),
          contentPadding:
  ...
  return Padding(
    ...
    child: TextField(
      ...
      decoration: InputDecoration(
        ...
        hintText: 'search...',
        hintStyle: const TextStyle(
            color: Colors.grey, fontFamily: 'Urbanist-regular', fontSize: 16),
        contentPadding:
            const EdgeInsets.symmetric(horizontal: 20, vertical: 20),
        focusedBorder: OutlineInputBorder(
